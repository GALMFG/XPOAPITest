...
namespace XPOAPITest
{
    class OrderRequest
    {
        ...
        public IList<OrderContactInformation> orderContactInformations { get; set; }
        ...
        public void addOrderContact(OrderContactInformation contact)
        {
            if (orderContactInformations is null)
                orderContactInformations = new List<OrderContactInformation>();
